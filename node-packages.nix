...
let
  sources = {
    ...
    "gulp-manifest-0.1.1" = {
      name = "gulp-manifest";
      packageName = "gulp-manifest";
      version = "0.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/gulp-manifest/-/gulp-manifest-0.1.1.tgz";
        sha1 = "68a801a5a15c12f7f3f1d34082070b534df9f717";
      };
    };
    "gulp-match-1.0.3" = {
      name = "gulp-match";
